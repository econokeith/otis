    ...
    while True:
        ...
        if face_results.multi_face_landmarks:
            for face_landmarks in face_results.multi_face_landmarks:
                ...
                cv2.line(image, xy_pixels[xc10], xy_pixels[xc11], (0, 0, 255), 2)
                cv2.line(image, xy_pixels[xc0], xy_pixels[xc1], (0, 0, 255), 2)
                cv2.line(image, xy_pixels[yc0], xy_pixels[yc1], (255,0 , 0), 2)
                ...
                cv2.circle(image, center_x_line, radius, (255,0, 0), -1)
                cv2.circle(image, center_x_line, radius, (255, 255, 255), 1)

                cv2.circle(image, center_x1_line, radius, (255, 0, 0), -1)
                cv2.circle(image, center_x1_line, radius, (255, 255, 255), 1)

                cv2.line(image, center_x_line, center_x1_line, (255, 0, 0), LINE_THICKNESS)

                cv2.circle(image, center_y_line, radius, (255,0, 0), -1)
                cv2.circle(image, center_y_line, radius, (255,255, 255), 1)

                cv2.circle(image, center_center_x, radius, (255, 0, 0), -1)
                cv2.circle(image, center_center_x, radius, (255, 255, 255), 1)

                cv2.line(image, center_y_line, center_x_line, (255,0,0), LINE_THICKNESS)
                cv2.line(image, center_y_line, center_x1_line, (255, 0, 0), LINE_THICKNESS)

                cv2.line(image, center_y_line, xy_pixels[xc0], (0, 255, 0))
                cv2.line(image, center_y_line, xy_pixels[xc1], (0, 255, 0))
                cv2.line(image, center_y_line, xy_pixels[xc10], (0, 255, 0))
                cv2.line(image, center_y_line, xy_pixels[xc11], (0, 255, 0))

                cv2.line(image, center_x_line, xy_pixels[yc0], (0, 255, 0))
                cv2.line(image, center_x1_line, xy_pixels[yc1], (0, 255, 0))

                cv2.putText(image, f'y_len ={int(average_height())}', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0))
                cv2.putText(image, f'x_len ={int(average_width())}', (50,100), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0))
                cv2.putText(image, f'ratio ={round(average_height()/average_width(), 2)}', (50,150), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0))
