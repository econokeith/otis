...
class TextWriter(bases.AssetWriter):
    ...
    def line_spacing(self):
        ...
        if isinstance(spacing, int):
            ...
            return int(spacing * self.get_text_size()[1])
        else:
    ...
    def write(self, frame, text=None, coords=None, color=None, ref=None, save=False):
        ...
        :type frame: np.array
        """
        _text, _coords, _color, _ref = misc.update_save_attributes_on_write(self, locals())
        ...
        if isinstance(self.outliner, shapes.Rectangle):
            ...
            self.outliner.write(frame, (0, -self.v_space, w, -self.v_space), color=_color, ref=justified_position)
        else:
            pass
    ...
    def write_fun(self, frame, *args, **kwargs):
        self.text = self.text_fun(*args, **kwargs)
        self.write(frame)
...
if __name__=='__main__':
    ...
    writer2 = TextWriter(coords=(100, 500),
