...
def get_default_pose_landmarks_style() -> Mapping[int, DrawingSpec]:
    """Returns the default pose landmarks_list drawing face_style.
    Returns:
...
def draw_pose_landmarks(
    ...
    Args:
      ...
      landmark_drawing_spec: Either a DrawingSpec object or a mapping from hand
        landmarks_list to the DrawingSpecs that specifies the landmarks_list' drawing
        settings such as color, line thickness, and circle radius. If this
        argument is explicitly set to None, no landmarks_list will be drawn.
